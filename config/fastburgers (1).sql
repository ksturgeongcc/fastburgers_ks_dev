...
--
-- Host: localhost:8889
-- Generation Time: Feb 25, 2026 at 09:02 AM
...
CREATE TABLE `customers` (
  ...
  `hashed_password` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
INSERT INTO `customers` (`customer_id`, `first_name`, `last_name`, `phone`, `email`, `created_at`, `hashed_password`) VALUES
...
INSERT INTO `products` (`product_id`, `sku`, `name`, `category`, `price_gbp`, `default_menu`, `is_active`, `created_at`) VALUES
(1, 'BRG-001', 'Classic Burger', 'burger', 4.99, 'regular', 1, '2026-02-17 22:11:05'),
(2, 'BRG-002', 'Cheese Burger', 'burger', 5.49, 'regular', 1, '2026-02-17 22:11:05'),
(3, 'CHP-001', 'Chips (Regular)', 'chips', 2.49, 'regular', 1, '2026-02-17 22:11:05'),
(4, 'DRK-001', 'Cola (500ml)', 'drink', 1.99, 'regular', 1, '2026-02-17 22:11:05'),
(5, 'BRF-001', 'Breakfast Muffin', 'breakfast', 3.49, 'regular', 1, '2026-02-17 22:11:05'),
(6, 'SAV-001', 'Saver Burger Deal', 'burger', 3.99, 'savers', 1, '2026-02-17 22:11:05'),
(7, 'SAV-002', 'Saver Chips Deal', 'chips', 1.49, 'savers', 1, '2026-02-17 22:11:05');
...
INSERT INTO `staff` (`staff_id`, `outlet_id`, `first_name`, `last_name`, `role`, `email`, `is_active`, `hired_on`, `created_at`) VALUES
(1, 1, 'Aisha', 'Khan', 'manager', 'aisha.khan@fastburgers.test', 1, '2024-01-10', '2026-02-17 22:11:05'),
(2, 1, 'Tom', 'Bennett', 'manager', 'tom.bennett@fastburgers.test', 1, '2024-02-12', '2026-02-17 22:11:05'),
(3, 1, 'Leah', 'Jones', 'sales', 'leah.jones@fastburgers.test', 1, '2024-04-01', '2026-02-17 22:11:05'),
(4, 1, 'Sam', 'Patel', 'sales', 'sam.patel@fastburgers.test', 1, '2024-05-15', '2026-02-17 22:11:05'),
(5, 1, 'Ivy', 'Wright', 'cook', 'ivy.wong@fastburgers.test', 1, '2024-03-20', '2026-02-17 22:11:05'),
(6, 2, 'Noah', 'Evans', 'manager', 'noah.evans@fastburgers.test', 1, '2023-11-05', '2026-02-17 22:11:05'),
(7, 2, 'Priya', 'Singh', 'manager', 'priya.singh@fastburgers.test', 1, '2024-01-22', '2026-02-17 22:11:05'),
(8, 2, 'Mia', 'Brown', 'sales', 'mia.brown@fastburgers.test', 1, '2024-02-14', '2026-02-17 22:11:05'),
(9, 2, 'Jack', 'White', 'sales', 'jack.white@fastburgers.test', 1, '2024-06-02', '2026-02-17 22:11:05'),
(10, 2, 'Ben', 'Green', 'cook', 'ben.green@fastburgers.test', 1, '2024-03-01', '2026-02-17 22:11:05');
